...
export default function CardIcon({ tab }: { tab: FavoriteTab }) {
	...
	return (
		<a
			...
			className="group relative h-44 rounded-3xl bg-white/60 dark:bg-gray-500/15 backdrop-blur-xl p-6 flex flex-col justify-center shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl text-center"
		>
			...
			{!isClean && (
				<>
					...
					<span className="mt-2 text-gray-600 dark:text-gray-400">{tab.description}</span>
				</>
			)}
		</a>
	);
